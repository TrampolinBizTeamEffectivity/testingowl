...
public class AudioCapture01 extends JFrame {
	...
	private void playAudio() {
		try {
			...
			def audioData = byteArrayOutputStream.toByteArray();
			...
			audioInputStream = new AudioInputStream(byteArrayInputStream,
					audioFormat, (audioData.length / audioFormat.getFrameSize()) as long);
			DataLine.Info dataLineInfo = new DataLine.Info(
					SourceDataLine.class, audioFormat);
			log.info ("supported?: " + dataLineInfo.isFormatSupported(audioFormat))
